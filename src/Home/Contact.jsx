  ...
  return (
    <>
      ...
      <div className="p-5 sm:flex text-white mb-10">
        <p className=" sm:w-3/5 text-white mb-5 ">
          ...
          website maintenance. I am proficient in programming languages such as
          HTML, CSS, JavaScript, React and . I believe that communication is key
          to a successful project, and I am committed to keeping you informed
          throughout the development process. I will work closely with you to
          ensure that your website meets your specific needs and exceeds your
          expectations. My goal is to provide you with a high-quality website
          that not only looks great but also performs well. I am confident that
          my skills and expertise make me the right fit for your project. Thank
          you for your consideration, and I look forward to the opportunity to
          work with you.
        </p>
